...
class CarControllerParams:
  ...
  def __init__(self, CP):
    ...
    if CP.flags & VolkswagenFlags.PQ:
      ...
      self.STEER_DELTA_UP = 30            # Max HCA reached in 0.60s (STEER_MAX / (50Hz * 0.60))
      self.STEER_DELTA_DOWN = 30          # Min HCA reached in 0.60s (STEER_MAX / (50Hz * 0.60))
