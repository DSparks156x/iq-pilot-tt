  ...
  def _initialize_items(self):
    ...
    items = [
      ...
      self._option_item(
        ...
        "How far ahead IQ.Pilot should apply an upcoming higher map speed limit.",
      ...
      self._option_item(
        ...
        "How far ahead IQ.Pilot should apply an upcoming lower map speed limit.",
